        ...
        $.fn.zyUpload = function(options,param){
          ...
          return this.each(function(){
            ...
            var defaults = {
                ...
                url              : "http://www.food.com/index.php/admin/upload/zyupload", // 上传文件的路径
            ...
            this.createCorePlug = function(){
              var params = {
                ...
                onSuccess: function(file, response) {
                  ...
                  $("#UpdateShow").show();//显示已上传文件 div
                  imgUrl = arr.data;//图片上传路径
                  $(":input[name='zyfile']").val(imgUrl);
                  var filelength = arr.data.length;//获取文件长度
                  $("#ImgUrl").append('<p>文件已成功上传1张！</p>');
                  
                  $("#GetUpdate").html("继续上传");
                  // console.log("22222");
                  $("#uploadProgress_" + file.index).hide();
                  $("#uploadSuccess_" + file.index).show();
                  $("#uploadInf").append("<p>文件成功上传！</p>");
                  // 根据配置参数确定隐不隐藏上传成功的文件
                  if(para.finishDel){
                    // 移除效果
                    $("#uploadList_" + file.index).fadeOut();
            ...
            this.addEvent = function(){
              ...
              $(".upload_btn").bind("click", function(e){
                $("input[name='file_start']").val("1");//赋值文件上传状态 1为发生改变
                // 判断当前是否有文件需要上传
